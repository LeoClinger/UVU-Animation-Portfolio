...
//Name: FKWalkcyle.ma
//Last modified: Mon, Oct 06, 2025 11:00:27 AM
//Codeset: UTF-8
file -rdi 1 -ns "Ultimate_Walker_FK_v1_0_1" -rfn "Ultimate_Walker_FK_v1_0_1RN"
		 -op "v=0;" -typ "mayaAscii" "/Users/leoclinger/Downloads/Ultimate_Walker_FK_v1.0.1.ma";
...
fileInfo "UUID" "0BB9C504-8042-5310-96D3-C397E9A17B35";
createNode transform -s -n "persp";
	rename -uid "540B4A87-5C41-4539-32A7-449584C658BD";
	setAttr ".v" no;
	setAttr ".t" -type "double3" 10.621476877521159 1.9706896032636898 -0.3604781768703515 ;
	setAttr ".r" -type "double3" 0 89.999999999999986 0 ;
	setAttr ".rp" -type "double3" 5.5511151231257827e-17 0 -1.7763568394002505e-15 ;
	setAttr ".rpt" -type "double3" -1.8332881098280368e-15 -1.2580324015746177e-18 1.719614890654475e-15 ;
createNode camera -s -n "perspShape" -p "persp";
	rename -uid "99A85459-E741-8330-BB12-AEBA069A9998";
	setAttr -k off ".v" no;
	setAttr ".fl" 34.999999999999986;
	setAttr ".coi" 10.621476877522348;
	setAttr ".imn" -type "string" "persp";
	setAttr ".den" -type "string" "persp_depth";
	setAttr ".man" -type "string" "persp_mask";
	setAttr ".tp" -type "double3" -3.5527136788005009e-15 1.9706896032636898 -0.36047817687035438 ;
	setAttr ".hc" -type "string" "viewSet -p %camera";
createNode transform -s -n "top";
	rename -uid "10088FF1-9D4D-2738-0A27-209A30A06D82";
	setAttr ".v" no;
	setAttr ".t" -type "double3" 0 1000.1 0 ;
	setAttr ".r" -type "double3" -89.999999999999986 0 0 ;
createNode camera -s -n "topShape" -p "top";
	rename -uid "2D04A1B9-F34E-99BD-9EA4-C1B866DEBC93";
	setAttr -k off ".v" no;
	setAttr ".rnd" no;
	setAttr ".coi" 1000.1;
	setAttr ".ow" 30;
...
createNode transform -s -n "front";
	rename -uid "E65301E2-5C49-D42F-8089-C7B33737B33E";
	setAttr ".v" no;
	setAttr ".t" -type "double3" 0 0 1000.1 ;
createNode camera -s -n "frontShape" -p "front";
	rename -uid "0AD8562A-2546-E53E-95D9-75820D16E816";
	setAttr -k off ".v" no;
	setAttr ".rnd" no;
	setAttr ".coi" 1000.1;
	setAttr ".ow" 30;
...
createNode transform -s -n "side";
	rename -uid "4EB4AD6D-5048-E31F-A4AC-EC84B1222CD0";
	setAttr ".v" no;
	setAttr ".t" -type "double3" 1000.1 0 0 ;
	setAttr ".r" -type "double3" 0 89.999999999999986 0 ;
createNode camera -s -n "sideShape" -p "side";
	rename -uid "89B6CDD9-C146-363A-19DF-FAACF09CE673";
	setAttr -k off ".v" no;
	setAttr ".rnd" no;
	setAttr ".coi" 1000.1;
	setAttr ".ow" 30;
...
createNode lightLinker -s -n "lightLinker1";
	rename -uid "4F8BAD59-4B42-0CCE-38E0-9397FBEA6E2C";
	setAttr -s 4 ".lnk";
	setAttr -s 4 ".slnk";
createNode shapeEditorManager -n "shapeEditorManager";
	rename -uid "1F1B9BF8-074D-8568-6D23-D49A4532D29B";
createNode poseInterpolatorManager -n "poseInterpolatorManager";
	rename -uid "53B30E3C-5C4E-49CD-AE6D-D6A24CA2E794";
createNode displayLayerManager -n "layerManager";
	rename -uid "564C413A-1240-11F6-2ED4-3F81C53A11DC";
createNode displayLayer -n "defaultLayer";
	rename -uid "02C7B17B-2147-06C9-07E7-68ACE7A25247";
	setAttr ".ufem" -type "stringArray" 0  ;
createNode renderLayerManager -n "renderLayerManager";
	rename -uid "45D21F78-5846-291A-BEFA-9FB8DDFC2506";
createNode renderLayer -n "defaultRenderLayer";
	rename -uid "BA155E4D-A342-8055-9C34-71A6929F7206";
	setAttr ".g" yes;
createNode aiOptions -s -n "defaultArnoldRenderOptions";
	rename -uid "7C4A9099-9D41-CF34-219D-F6A08D0E30AD";
	setAttr ".version" -type "string" "5.4.8.2";
createNode aiAOVFilter -s -n "defaultArnoldFilter";
	rename -uid "087F46ED-9F46-6346-F6F3-FCA887A6B296";
	setAttr ".ai_translator" -type "string" "gaussian";
createNode aiAOVDriver -s -n "defaultArnoldDriver";
	rename -uid "E5C314EA-2345-DD2D-3BCB-118BE1BF6149";
	setAttr ".ai_translator" -type "string" "exr";
createNode aiAOVDriver -s -n "defaultArnoldDisplayDriver";
	rename -uid "E850A521-EC43-F9A5-F465-2E84ACC2F8C0";
	setAttr ".ai_translator" -type "string" "maya";
	setAttr ".output_mode" 0;
createNode aiImagerDenoiserOidn -s -n "defaultArnoldDenoiser";
	rename -uid "0C2E5D74-854B-8DDF-09A2-578FE1DFE8FC";
createNode reference -n "Ultimate_Walker_FK_v1_0_1RN";
	rename -uid "69B17D99-BC4A-4C53-BC4D-1194558F125F";
	setAttr -s 10 ".phl";
	setAttr ".phl[1]" 0;
	setAttr ".phl[2]" 0;
	setAttr ".phl[3]" 0;
	...
	setAttr ".ed" -type "dataReferenceEdits" 
		...
		"rotate" " -type \"double3\" 0 0 -51.24003591028225202"
		...
		"rotate" " -type \"double3\" 0 0 6.23932060387477616"
		...
		"rotate" " -type \"double3\" 0 0 23.53964028508079664"
		...
		"rotate" " -type \"double3\" 0 0 27.14784832813161941"
		...
		"rotate" " -type \"double3\" 0 0 1.88843325071780122"
		...
		"rotate" " -type \"double3\" 0 0 7.02202742140359337"
		...
		"rotate" " -type \"double3\" 0.43932992868994608 -4.78266713918511233 15.90828733944614726"
		...
		"rotate" " -type \"double3\" 4.31816801796199012 4.43459431653429803 -46.88352584563465086"
		...
		"translate" " -type \"double3\" 0 -0.31765077872659458 0"
		2 "|Ultimate_Walker_FK_v1_0_1:AniM_walker_Main|Ultimate_Walker_FK_v1_0_1:Body_Rig_Grp|Ultimate_Walker_FK_v1_0_1:CNT_Grp|Ultimate_Walker_FK_v1_0_1:CTRL_Main_Grp|Ultimate_Walker_FK_v1_0_1:CTRL_Main" 
...
createNode reference -n "sharedReferenceNode";
	rename -uid "9D79F8B0-D24A-66E6-5268-F5AB9F322D3C";
	setAttr ".ed" -type "dataReferenceEdits" 
		"sharedReferenceNode";
createNode script -n "uiConfigurationScriptNode";
	rename -uid "E007C9C1-C244-A3E7-2715-4D868BB0E97F";
...
createNode script -n "sceneConfigurationScriptNode";
	rename -uid "C4AE6122-C542-5EED-C28C-AF86BE9F2ABD";
	setAttr ".b" -type "string" "playbackOptions -min 1 -max 24 -ast 1 -aet 200 ";
	setAttr ".st" 6;
createNode animCurveTL -n "CTRL_Main_translateY";
	rename -uid "790E3404-684E-2757-12B9-0C90DEEE1C1A";
	setAttr ".tan" 18;
	setAttr ".wgt" no;
	setAttr -s 9 ".ktv[0:8]"  1 -0.47704473250651525 4 -0.8674661075279424
		 7 0 10 0.11857175913080908 13 -0.447 16 -0.8996752408828419 19 0 22 0.13763271062599136
		 25 -0.477;
createNode animCurveTA -n "walker_lf_ball_fk_ctrl_rotateZ";
	rename -uid "2ACDDDA5-414D-8A02-B9D1-33BE822864E4";
	setAttr ".tan" 18;
	setAttr ".wgt" no;
	setAttr -s 9 ".ktv[0:8]"  1 -56.3913388504577 4 -43.042762111682457
		 7 23.103755910220535 10 0 13 0 16 0 19 0 22 -29.599997855880012 25 -56.013380218402908;
createNode animCurveTA -n "walker_lf_upLeg_fk_ctrl_rotateZ";
	rename -uid "D00E71A3-3244-1809-4689-A0BFC94E21B1";
	setAttr ".tan" 18;
	setAttr ".wgt" no;
	setAttr -s 13 ".ktv[0:12]"  1 29.827795680153638 4 36.498604599597584
		 7 -18.836776533794545 10 -54.554470269497671 13 -47.579242448573972 14 -59.572970730423464
		 15 -80.563790296661907 16 -73.081196580363041 17 -60.759459631177293 18 -35.991435325457353
		 19 0 22 13.42057767545738 25 30.43085053006439;
	setAttr -s 13 ".kbd[5:12]" yes yes no yes yes no no no;
createNode animCurveTA -n "walker_rt_upLeg_fk_ctrl_rotateZ";
	rename -uid "BFE8909D-664E-2A26-603D-76BE4FA9A2CA";
	setAttr ".tan" 18;
	setAttr ".wgt" no;
	setAttr -s 14 ".ktv[0:13]"  1 -40.787441345711045 2 -61.913285871531421
		 3 -76.567029837939103 4 -76.942339120103753 5 -63.49073801052775 6 -39.828248561926664
		 7 0 10 19.112122476162671 13 29.828 16 26.242198711674714 19 -16.650474207436407
		 22 -48.027661339063371 23 -53.267051691269266 25 -40.5;
	setAttr -s 14 ".kbd[1:13]" yes yes no yes yes no no no no no no yes 
		no;
createNode animCurveTA -n "walker_rt_knee_fk_ctrl_rotateZ";
	rename -uid "4E93385E-8241-7D33-F72C-C78FE9C457AA";
	setAttr ".tan" 18;
	setAttr ".wgt" no;
	setAttr -s 13 ".ktv[0:12]"  1 0 2 38.594754010485978 3 85.268262945993285
		 4 101.22686705343915 5 84.798225785714038 6 50.412333940869935 7 0 10 0 13 31.5 16 69.5553857872045
		 19 99.155805912533324 22 75.525652011082684 25 0;
	setAttr -s 13 ".kbd[1:12]" yes yes no yes yes no no no no no no no;
createNode animCurveTA -n "walker_rt_ankle_fk_ctrl_rotateZ";
	rename -uid "DC49141E-F54D-836A-3D8D-1E809565E692";
	setAttr ".tan" 18;
	setAttr ".wgt" no;
	setAttr -s 10 ".ktv[0:9]"  1 0 4 -24.410904141778648 7 0 10 28.597708313195621
		 13 2.776820019774751 16 -10.766617933926034 19 25.260904276957703 22 58.201353712659483
		 23 23.744280461583735 25 0;
	setAttr -s 10 ".kbd[8:9]" yes no;
createNode animCurveTA -n "walker_rt_ball_fk_ctrl_rotateZ";
	rename -uid "B3A89003-D349-8D81-D11A-5993A08CAF92";
	setAttr ".tan" 18;
	setAttr ".wgt" no;
	setAttr -s 9 ".ktv[0:8]"  1 0 4 0 7 0 10 -33.30489615808915 13 -56.4
		 16 -50.716823230138409 19 28.929087601102538 22 11.416683624354734 25 0;
createNode animCurveTA -n "walker_lf_knee_fk_ctrl_rotateZ";
	rename -uid "BD1A92A2-D041-2905-71F7-82916C6D6735";
	setAttr ".tan" 18;
	setAttr ".wgt" no;
	setAttr -s 11 ".ktv[0:10]"  1 31.496720692631772 4.0000001700680272 54.625262796487831
		 7 89.944274783487913 10 78.741739052819113 13 0 16 109.68301764320663 17 95.873739596960348
		 18 63.126729603005039 19 0 22 0 25 31.77851438485909;
	setAttr -s 11 ".kbd[6:10]" yes yes no no no;
createNode animCurveTA -n "walker_lf_ankle_fk_ctrl_rotateZ";
	rename -uid "638859DA-C141-B549-3D35-07AE0B85D79A";
	setAttr ".tan" 18;
	setAttr ".wgt" no;
	setAttr -s 12 ".ktv[0:11]"  1 0 4 -11.62938221832415 7 40.70709636922367
		 10 51.378358895712452 13 0 15 -16.712015912389997 16 -35.629707041124206 17 -34.147342289341111
		 18 -25.900731946934432 19 0 22 24.065950900659832 25 0;
	setAttr -s 12 ".kbd[5:11]" yes no yes yes no no no;
createNode animCurveTL -n "CTRL_Top_translateY";
	rename -uid "875D0CA0-D347-1593-0836-2DB4F67B7D56";
	setAttr ".tan" 18;
	setAttr ".wgt" no;
	setAttr -s 5 ".ktv[0:4]"  1 0.25 5 -0.25 11 0.25 17 -0.2512295081967213
		 23 0.2;
	setAttr -s 5 ".kbd[0:4]" yes yes yes yes yes;
	setAttr -s 5 ".kit[1:4]"  1 18 1 18;
	setAttr -s 5 ".kot[1:4]"  1 18 1 18;
	setAttr -s 5 ".ktl[1:4]" no yes no yes;
	setAttr -s 5 ".kix[1:4]"  0.24003239531275999 1 0.37929345111745938 
		1;
	setAttr -s 5 ".kiy[1:4]"  -0.97076487843371173 0 -0.92527643325624997 
		0;
	setAttr -s 5 ".kox[1:4]"  0.31379532559943496 1 0.34356256509875421 
		1;
	setAttr -s 5 ".koy[1:4]"  0.94949064957583695 0 0.93912979074394409 
		0;
select -ne :time1;
	setAttr ".o" 24;
	setAttr ".unw" 24;
...
select -ne :hardwareRenderGlobals;
	...
	setAttr ".btrs" 512;
select -ne :ikSystem;
connectAttr "walker_lf_ball_fk_ctrl_rotateZ.o" "Ultimate_Walker_FK_v1_0_1RN.phl[1]"
		;
connectAttr "walker_lf_ankle_fk_ctrl_rotateZ.o" "Ultimate_Walker_FK_v1_0_1RN.phl[2]"
		;
connectAttr "walker_lf_knee_fk_ctrl_rotateZ.o" "Ultimate_Walker_FK_v1_0_1RN.phl[3]"
		;
connectAttr "walker_lf_upLeg_fk_ctrl_rotateZ.o" "Ultimate_Walker_FK_v1_0_1RN.phl[4]"
		;
connectAttr "walker_rt_ball_fk_ctrl_rotateZ.o" "Ultimate_Walker_FK_v1_0_1RN.phl[5]"
		;
connectAttr "walker_rt_ankle_fk_ctrl_rotateZ.o" "Ultimate_Walker_FK_v1_0_1RN.phl[6]"
		;
connectAttr "walker_rt_knee_fk_ctrl_rotateZ.o" "Ultimate_Walker_FK_v1_0_1RN.phl[7]"
		;
connectAttr "walker_rt_upLeg_fk_ctrl_rotateZ.o" "Ultimate_Walker_FK_v1_0_1RN.phl[8]"
		;
connectAttr "CTRL_Top_translateY.o" "Ultimate_Walker_FK_v1_0_1RN.phl[9]";
connectAttr "CTRL_Main_translateY.o" "Ultimate_Walker_FK_v1_0_1RN.phl[10]";
