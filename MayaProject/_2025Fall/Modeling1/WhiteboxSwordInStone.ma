...
//Last modified: Mon, Sep 15, 2025 12:32:39 PM
//Codeset: UTF-8
...
fileInfo "UUID" "3992B6F6-0B49-04E5-4EE4-498A8194F993";
createNode transform -s -n "persp";
	rename -uid "7C59A877-D343-B655-E210-97B44E5537E0";
	setAttr ".v" no;
	setAttr ".t" -type "double3" -0.44203435980126349 3.5613084094471565 22.713011991354662 ;
...
createNode camera -s -n "perspShape" -p "persp";
	...
	setAttr ".fcp" 100;
	setAttr ".fd" 0.05;
	setAttr ".coi" 26.289257441313008;
	setAttr ".ow" 0.1;
