...
//Name: FinalScene.ma
//Last modified: Fri, Dec 12, 2025 12:51:17 PM
//Codeset: UTF-8
...
fileInfo "UUID" "852A08F8-7D4B-9E92-627B-FDB83DD89E23";
createNode transform -s -n "persp";
	rename -uid "EACD3A97-8244-D3C0-32CA-3F98DC27F215";
	setAttr ".v" no;
	setAttr ".t" -type "double3" 5.3980175870256426 6.0641520643562741 9.785415417352775 ;
	setAttr ".r" -type "double3" -29.138352729758708 391.39999999959133 0 ;
createNode camera -s -n "perspShape" -p "persp";
	...
	setAttr ".fcp" 100;
	setAttr ".fd" 0.05;
	setAttr ".coi" 9.5616983404356759;
	setAttr ".ow" 0.1;
...
createNode lightLinker -s -n "lightLinker1";
	rename -uid "0F03A24A-E44B-EFF7-7EEB-EDAB845AFAF8";
	setAttr -s 15 ".lnk";
	setAttr -s 15 ".slnk";
createNode shapeEditorManager -n "shapeEditorManager";
	rename -uid "427F4369-2F47-240C-3D05-7C951531BFEF";
createNode poseInterpolatorManager -n "poseInterpolatorManager";
	rename -uid "7D1C3CF8-1A4D-BEB2-BFFA-91AA3B688A22";
createNode displayLayerManager -n "layerManager";
	rename -uid "5666B362-E245-0E22-E6F4-9E861A0D65EE";
createNode displayLayer -n "defaultLayer";
	rename -uid "3ECDBB95-374E-D587-2B23-F39A7A0EB91F";
	setAttr ".ufem" -type "stringArray" 0  ;
createNode renderLayerManager -n "renderLayerManager";
	rename -uid "7B08B2A3-5044-F600-45CF-9EAB374C379E";
...
createNode nodeGraphEditorInfo -n "hyperShadePrimaryNodeEditorSavedTabsInfo";
	rename -uid "DFF29612-9A46-DFEF-A131-D092650A5BF3";
	setAttr ".tgi[0].tn" -type "string" "Untitled_1";
	setAttr ".tgi[0].vl" -type "double2" 10090.398360174062 1109.0204747081025 ;
	setAttr ".tgi[0].vh" -type "double2" 12588.172167231942 2756.4071688287181 ;
	setAttr -s 6 ".tgi[0].ni";
	setAttr ".tgi[0].ni[0].x" 3422.857177734375;
	setAttr ".tgi[0].ni[0].y" 1031.4285888671875;
	setAttr ".tgi[0].ni[0].nvs" 1923;
	setAttr ".tgi[0].ni[1].x" 3115.71435546875;
	setAttr ".tgi[0].ni[1].y" 1031.4285888671875;
	setAttr ".tgi[0].ni[1].nvs" 1923;
	setAttr ".tgi[0].ni[2].x" 597.6190185546875;
	setAttr ".tgi[0].ni[2].y" -20.238094329833984;
	setAttr ".tgi[0].ni[2].nvs" 1923;
	setAttr ".tgi[0].ni[3].x" 2808.571533203125;
	setAttr ".tgi[0].ni[3].y" 1010;
	setAttr ".tgi[0].ni[3].nvs" 1923;
	setAttr ".tgi[0].ni[4].x" 377.38095092773438;
	setAttr ".tgi[0].ni[4].y" -20.238094329833984;
	setAttr ".tgi[0].ni[4].nvs" 1923;
	setAttr ".tgi[0].ni[5].x" 3730;
	setAttr ".tgi[0].ni[5].y" 1032.857177734375;
...
connectAttr "ShieldNewTex.msg" "hyperShadePrimaryNodeEditorSavedTabsInfo.tgi[0].ni[0].dn"
		;
...
connectAttr "place2dTexture2.msg" "hyperShadePrimaryNodeEditorSavedTabsInfo.tgi[0].ni[3].dn"
		;
connectAttr "GroundMat.msg" "hyperShadePrimaryNodeEditorSavedTabsInfo.tgi[0].ni[4].dn"
		;
