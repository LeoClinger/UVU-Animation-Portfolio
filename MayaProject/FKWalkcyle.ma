...
//Name: FKWalkcyle.ma
//Last modified: Sat, Oct 04, 2025 08:35:27 PM
//Codeset: UTF-8
...
fileInfo "UUID" "62AE8D46-F041-B84C-F12E-7881F4320C6D";
createNode transform -s -n "persp";
	rename -uid "540B4A87-5C41-4539-32A7-449584C658BD";
	setAttr ".v" no;
	setAttr ".t" -type "double3" -8.131652918164443 0.55310264817270682 0.12251850338078225 ;
	setAttr ".r" -type "double3" 3.2616472644303993 267.39999999985275 0 ;
createNode camera -s -n "perspShape" -p "persp";
	rename -uid "99A85459-E741-8330-BB12-AEBA069A9998";
	setAttr -k off ".v" no;
	setAttr ".fl" 34.999999999999993;
	setAttr ".coi" 7.3240905205099667;
...
createNode lightLinker -s -n "lightLinker1";
	rename -uid "45BB8845-8640-3254-05BC-2099CC70E8BA";
	setAttr -s 4 ".lnk";
	setAttr -s 4 ".slnk";
createNode shapeEditorManager -n "shapeEditorManager";
	rename -uid "489DF09C-D048-7F26-2D5E-6C8EED530111";
createNode poseInterpolatorManager -n "poseInterpolatorManager";
	rename -uid "4F547682-B04A-9D30-5394-22BC94618270";
createNode displayLayerManager -n "layerManager";
	rename -uid "77CE02EE-1346-C1E6-606D-EC8AD2D240EA";
createNode displayLayer -n "defaultLayer";
	rename -uid "02C7B17B-2147-06C9-07E7-68ACE7A25247";
	setAttr ".ufem" -type "stringArray" 0  ;
createNode renderLayerManager -n "renderLayerManager";
	rename -uid "EB3EDFFF-F94E-5E61-89FA-CA8A6F005B31";
...
createNode reference -n "Ultimate_Walker_FK_v1_0_1RN";
	...
	setAttr ".ed" -type "dataReferenceEdits" 
		...
		"rotate" " -type \"double3\" 0 0 -43.0427621116824568"
		...
		"rotate" " -type \"double3\" 0 0 -11.62938221832414953"
		...
		"rotate" " -type \"double3\" 0 0 54.62526113981108011"
		...
		"rotate" " -type \"double3\" 0 0 36.4986045995975843"
		...
		"rotate" " -type \"double3\" 0 0 -24.41090414177864787"
		...
		"rotate" " -type \"double3\" 0.43932992868994608 -4.78266713918511233 101.22686705343915037"
		...
		"rotate" " -type \"double3\" 4.31816801796199012 4.43459431653429803 -76.9423391201037532"
		...
		"translate" " -type \"double3\" 0 -0.8674661075279424 0"
		2 "|Ultimate_Walker_FK_v1_0_1:AniM_walker_Main|Ultimate_Walker_FK_v1_0_1:Body_Rig_Grp|Ultimate_Walker_FK_v1_0_1:CNT_Grp|Ultimate_Walker_FK_v1_0_1:CTRL_Main_Grp|Ultimate_Walker_FK_v1_0_1:CTRL_Main" 
		"rotate" " -type \"double3\" 0 0 0"
		2 "|Ultimate_Walker_FK_v1_0_1:AniM_walker_Main|Ultimate_Walker_FK_v1_0_1:Body_Rig_Grp|Ultimate_Walker_FK_v1_0_1:CNT_Grp|Ultimate_Walker_FK_v1_0_1:CTRL_Main_Grp|Ultimate_Walker_FK_v1_0_1:CTRL_Main" 
...
createNode animCurveTA -n "walker_rt_upLeg_fk_ctrl_rotateZ";
	...
	setAttr -s 14 ".ktv[0:13]"  1 -40.787441345711045 2 -61.913285871531421
		 ...
		 7 0 10 19.112122476162671 13 29.828 16 26.242198711674714 19 -16.650474207436403
...
createNode animCurveTA -n "walker_rt_knee_fk_ctrl_rotateZ";
	...
	setAttr -s 13 ".ktv[0:12]"  1 0 2 38.594754010485978 3 85.268262945993285
		 4 101.22686705343915 5 84.798225785714038 6 50.412333940869928 7 0 10 0 13 31.5 16 69.5553857872045
		 19 99.15580591253331 22 75.525652011082684 25 0;
...
createNode animCurveTA -n "walker_lf_knee_fk_ctrl_rotateZ";
	...
	setAttr ".tan" 18;
	setAttr ".wgt" no;
	setAttr -s 11 ".ktv[0:10]"  1 31.496720692631772 4.0000001700680272 54.625262796487824
...
createNode animCurveTL -n "CTRL_Top_translateY";
	...
	setAttr ".tan" 18;
	setAttr ".wgt" no;
	setAttr -s 7 ".ktv[0:6]"  1 0.25 5 -0.25 8 0 11 0.25 17 -0.25 20 0
		 23 0.25;
